...
from alipay.compat import quote_plus, urlopen, decodebytes, encodebytes, b
...
if __name__ == '__main__':
    ...
    alipay = AliPay(
        ...
        app_notify_url="https://192.168.27.53：8000/",
        app_private_key_path=r"key/private.txt",
        alipay_public_key_path=r"key/alipay",
        sign_type="RSA2",
        debug=True,
    )
    url = alipay.api_alipay_trade_page_pay(
        subject="多多测试",
        out_trade_no="20181102090619557",
        total_amount=1,
        return_url="http://192.168.27.53:8000/goods/goods/",
        # qr_pay_mode=2,
        # qrcode_width=100

    )
    re_l = "https://openapi.alipaydev.com/gateway.do?{date}".format(date=url)
    print(re_l)